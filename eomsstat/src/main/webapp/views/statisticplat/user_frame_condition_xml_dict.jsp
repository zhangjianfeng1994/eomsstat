...
<script type="text/javascript">
			...
			function deptConfirm(){
			    ...
			    var setting = {  
			         ...
			         async: {
			             enable: true,
			             url:"${pageContext.request.contextPath}/tawStatisticModel/index_sub_tree_dict.json?defaultRoot="+$("#dict_root").val(),
			             autoParam:["id=pid"]
			         },
			         callback:{
			    ...
			    //加载部门
				var a= new dialogComponent("网络分类查询","<ul id='tree' class='ztree'></ul>","indexAddModal",null,"indexAddModelDiv");
...
<input type="hidden" id="dict_root" name="dict_root"/>
	...
	<div id="mainWrap">
		...
		name="query_end_time" size="20" placeholder="请输入日报时间"/></td></tr>
					<tr class="tablerowodd"><td align="center"><b>网络分类选择</b></td><td><a onclick="deptConfirm()"><span class="glyphicon glyphicon-search" aria-hidden="true"></span></a> | <span class="contend" id="deptNames"></span><input type="hidden" id="deptIds"/></td></tr>
