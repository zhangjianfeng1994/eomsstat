...
import com.boco.eoms.tawStatisticModel.model.FieldInfo;
...
@Service
public class TawStatisticDetailSrv {
	...
	//详单方法
	public String showDetailPageXml(String modelId_v,String detailpage_v,String time_v,String where_bufer,String reserve){
	...
	//数据生成
	public String getInitParam(String detailpage_v,String time_v,String where_bufer){
		//获取数据
